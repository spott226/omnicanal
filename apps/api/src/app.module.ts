...
@Module({
  ...
  providers: [PrismaService, AuthService, ResourceService, SessionGuard, TenantGuard, CsrfGuard, RolesGuard, ConfigService, { provide: APP_GUARD, useClass: ThrottlerGuard }],
})
