...
import { BillingMockActionDto, CheckoutDto, ReconcileCheckoutDto } from "./billing.dto";
...
export class BillingController {
  ...
  @Post("stripe/reconcile") @Protected(...ADMINS) reconcileStripeCheckout(@CurrentPrincipal() principal: AuthPrincipal, @Body() dto: ReconcileCheckoutDto) { return this.billing.reconcileStripeCheckout(principal, dto.sessionId); }
